...
urlpatterns = [
    ...
    path('orders/<str:code>/pdf', views.OrderPdfView.as_view(), name='order-pdf'),
    ...
    path('admin/orders/delivery-check', views.OrderDeliveryCheckView.as_view(), name='order-delivery-check'),
